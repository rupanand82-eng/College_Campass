import { College, Course, PlacementYear, Review, PredictorCutoff } from "../types";

export interface FullCollegeSeedData {
  college: College;
  courses: Course[];
...
export const SEED_COLLEGES: FullCollegeSeedData[] = [
  // 1. IIT Bombay
  {
    college: {
      id: "iit-bombay",
    ...
    courses: [
      { id: "iitb-cse", collegeId: "iit-bombay", name: "Computer Science and Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 220000, seats: 120, eligibility: "JEE Advanced top rankers + 75% in 10+2" },
      { id: "iitb-ee", collegeId: "iit-bombay", name: "Electrical Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 220000, seats: 110, eligibility: "JEE Advanced + 75% in 10+2" },
      { id: "iitb-me", collegeId: "iit-bombay", name: "Mechanical Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 220000, seats: 140, eligibility: "JEE Advanced + 75% in 10+2" },
      { id: "iitb-mba", collegeId: "iit-bombay", name: "Master of Management (SJMSOM)", degree: "MBA", durationYears: 2, feesPerYear: 500000, seats: 152, eligibility: "CAT percentile >= 98.5 + Bachelor's in Engineering/Science" },
    ],
    placements: [
      { id: "iitb-p2024", collegeId: "iit-bombay", year: 2024, avgPackageLPA: 23.5, medianPackageLPA: 19.2, highestPackageLPA: 168.0, placementPercentage: 94.2, topRecruiters: ["Google", "Microsoft", "Jane Street", "Apple", "Rubrik", "Qualcomm"] },
      { id: "iitb-p2023", collegeId: "iit-bombay", year: 2023, avgPackageLPA: 21.8, medianPackageLPA: 18.0, highestPackageLPA: 132.0, placementPercentage: 96.1, topRecruiters: ["Uber", "Texas Instruments", "Morgan Stanley", "Tower Research", "Samsung"] },
    ],
    reviews: [
  ...
  // 2. IIT Delhi
  {
    college: {
      ...
      city: "New Delhi",
      state: "Delhi",
      location: { lat: 28.5450, lng: 77.1926 },
      type: "Government",
      established: 1961,
      feesPerYear: 225000,
      rating: 4.9,
    ...
    courses: [
      { id: "iitd-cse", collegeId: "iit-delhi", name: "Computer Science and Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 225000, seats: 115, eligibility: "JEE Advanced top percentile + 75% in 10+2" },
      { id: "iitd-mnc", collegeId: "iit-delhi", name: "Mathematics and Computing", degree: "B.Tech", durationYears: 4, feesPerYear: 225000, seats: 90, eligibility: "JEE Advanced rankers" },
      { id: "iitd-ee", collegeId: "iit-delhi", name: "Electrical Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 225000, seats: 120, eligibility: "JEE Advanced rankers" },
      { id: "iitd-mba", collegeId: "iit-delhi", name: "MBA in Management Studies (DMS)", degree: "MBA", durationYears: 2, feesPerYear: 480000, seats: 115, eligibility: "CAT 98.0+ percentile" },
    ],
    placements: [
      { id: "iitd-p2024", collegeId: "iit-delhi", year: 2024, avgPackageLPA: 22.8, medianPackageLPA: 18.5, highestPackageLPA: 150.0, placementPercentage: 93.8, topRecruiters: ["Microsoft", "Google", "Goldman Sachs", "NVIDIA", "Bain & Company"] },
      { id: "iitd-p2023", collegeId: "iit-delhi", year: 2023, avgPackageLPA: 21.2, medianPackageLPA: 17.5, highestPackageLPA: 125.0, placementPercentage: 95.4, topRecruiters: ["Amazon", "Optiver", "Citadel", "McKinsey", "Intel"] },
    ],
    reviews: [
  ...
  // 3. IIT Madras
  {
    ...
    courses: [
      { id: "iitm-cse", collegeId: "iit-madras", name: "Computer Science and Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 215000, seats: 110, eligibility: "JEE Advanced" },
      { id: "iitm-ee", collegeId: "iit-madras", name: "Electrical Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 215000, seats: 120, eligibility: "JEE Advanced" },
      { id: "iitm-aero", collegeId: "iit-madras", name: "Aerospace Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 215000, seats: 60, eligibility: "JEE Advanced" },
      { id: "iitm-mba", collegeId: "iit-madras", name: "Master of Business Administration (DoMS)", degree: "MBA", durationYears: 2, feesPerYear: 450000, seats: 100, eligibility: "CAT 96+ percentile" },
    ],
    placements: [
      { id: "iitm-p2024", collegeId: "iit-madras", year: 2024, avgPackageLPA: 22.0, medianPackageLPA: 18.0, highestPackageLPA: 140.0, placementPercentage: 92.5, topRecruiters: ["Texas Instruments", "Qualcomm", "Microsoft", "Cisco", "Airbus", "ISRO"] },
      { id: "iitm-p2023", collegeId: "iit-madras", year: 2023, avgPackageLPA: 20.9, medianPackageLPA: 17.0, highestPackageLPA: 115.0, placementPercentage: 94.0, topRecruiters: ["Google", "Amazon", "Honeywell", "L&T", "McKinsey"] },
    ],
    reviews: [
  ...
  // 4. BITS Pilani
  {
    college: {
      ...
      city: "Pilani",
      state: "Rajasthan",
      location: { lat: 28.3639, lng: 75.5870 },
      type: "Deemed",
      established: 1964,
      feesPerYear: 520000,
      rating: 4.8,
    ...
    courses: [
      { id: "bits-cse", collegeId: "bits-pilani", name: "Computer Science", degree: "B.E.", durationYears: 4, feesPerYear: 520000, seats: 150, eligibility: "BITSAT exam score + 75% in PCM" },
      { id: "bits-eee", collegeId: "bits-pilani", name: "Electrical and Electronics Engineering", degree: "B.E.", durationYears: 4, feesPerYear: 520000, seats: 130, eligibility: "BITSAT exam score" },
      { id: "bits-mech", collegeId: "bits-pilani", name: "Mechanical Engineering", degree: "B.E.", durationYears: 4, feesPerYear: 520000, seats: 140, eligibility: "BITSAT exam score" },
      { id: "bits-eco", collegeId: "bits-pilani", name: "Economics + Computer Science (Dual)", degree: "M.Sc + B.E.", durationYears: 5, feesPerYear: 520000, seats: 80, eligibility: "BITSAT score" },
    ],
    placements: [
      { id: "bits-p2024", collegeId: "bits-pilani", year: 2024, avgPackageLPA: 20.5, medianPackageLPA: 17.0, highestPackageLPA: 90.0, placementPercentage: 92.0, topRecruiters: ["Google", "Oracle", "NVIDIA", "DE Shaw", "Amazon", "Uber"] },
      { id: "bits-p2023", collegeId: "bits-pilani", year: 2023, avgPackageLPA: 19.2, medianPackageLPA: 16.0, highestPackageLPA: 82.0, placementPercentage: 94.0, topRecruiters: ["Microsoft", "Cisco", "Adobe", "Morgan Stanley"] },
    ],
    reviews: [
    ...
    cutoffs: [
      ...
      { id: "c-bits-mech-gen", collegeId: "bits-pilani", exam: "JEE Main", category: "General", year: 2024, closingRank: 11000, course: "Mechanical Engineering" },
    ],
  },
  ...
  // 5. AIIMS New Delhi
  {
    college: {
      ...
      type: "Government",
      established: 1956,
      feesPerYear: 1628, // Genuine nominal AIIMS fee
      rating: 4.9,
      reviewCount: 32,
    ...
    placements: [
      { id: "aiims-p2024", collegeId: "aiims-delhi", year: 2024, avgPackageLPA: 18.0, medianPackageLPA: 16.5, highestPackageLPA: 45.0, placementPercentage: 99.0, topRecruiters: ["Apollo Hospitals", "Max Healthcare", "Fortis", "NHS UK", "US Residency Match"] },
      { id: "aiims-p2023", collegeId: "aiims-delhi", year: 2023, avgPackageLPA: 16.5, medianPackageLPA: 15.0, highestPackageLPA: 40.0, placementPercentage: 99.0, topRecruiters: ["Medanta", "Manipal Hospitals", "Johns Hopkins Fellowships"] },
    ],
    reviews: [
  ...
  // 6. IIM Ahmedabad
  {
    ...
    courses: [
      { id: "iima-pgp", collegeId: "iim-ahmedabad", name: "Post Graduate Programme in Management (MBA)", degree: "MBA", durationYears: 2, feesPerYear: 1400000, seats: 395, eligibility: "CAT 99.5+ percentile + WAT/PI" },
      { id: "iima-fabm", collegeId: "iim-ahmedabad", name: "PGP in Food and Agribusiness Management", degree: "MBA", durationYears: 2, feesPerYear: 1250000, seats: 50, eligibility: "CAT 96+ percentile" },
    ],
    placements: [
      { id: "iima-p2024", collegeId: "iim-ahmedabad", year: 2024, avgPackageLPA: 34.5, medianPackageLPA: 31.5, highestPackageLPA: 115.0, placementPercentage: 100.0, topRecruiters: ["McKinsey & Co", "Boston Consulting Group", "Bain & Company", "Goldman Sachs", "Blackstone"] },
      { id: "iima-p2023", collegeId: "iim-ahmedabad", year: 2023, avgPackageLPA: 32.8, medianPackageLPA: 30.0, highestPackageLPA: 105.0, placementPercentage: 100.0, topRecruiters: ["Morgan Stanley", "Kearney", "Hindustan Unilever", "Tata Sons"] },
    ],
    reviews: [
  ...
  // 7. NIT Trichy
  {
    ...
    courses: [
      { id: "nitt-cse", collegeId: "nit-trichy", name: "Computer Science and Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 155000, seats: 120, eligibility: "JEE Main top ranks (JoSAA counseling)" },
      { id: "nitt-ece", collegeId: "nit-trichy", name: "Electronics & Communication Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 155000, seats: 110, eligibility: "JEE Main" },
      { id: "nitt-mech", collegeId: "nit-trichy", name: "Mechanical Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 155000, seats: 120, eligibility: "JEE Main" },
      { id: "nitt-mba", collegeId: "nit-trichy", name: "MBA in Management Studies", degree: "MBA", durationYears: 2, feesPerYear: 190000, seats: 90, eligibility: "CAT 85+ percentile" },
    ],
    placements: [
      { id: "nitt-p2024", collegeId: "nit-trichy", year: 2024, avgPackageLPA: 15.8, medianPackageLPA: 13.0, highestPackageLPA: 52.0, placementPercentage: 91.0, topRecruiters: ["Microsoft", "Qualcomm", "Amazon", "Samsung R&D", "L&T", "Tata Motors"] },
      { id: "nitt-p2023", collegeId: "nit-trichy", year: 2023, avgPackageLPA: 14.9, medianPackageLPA: 12.5, highestPackageLPA: 48.0, placementPercentage: 93.0, topRecruiters: ["Texas Instruments", "Oracle", "Goldman Sachs"] },
    ],
    reviews: [
  ...
  // 8. VIT Vellore
  {
    ...
    courses: [
      { id: "vit-cse", collegeId: "vit-vellore", name: "Computer Science and Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 295000, seats: 800, eligibility: "VITEEE rank + 60% in 10+2" },
      { id: "vit-ai", collegeId: "vit-vellore", name: "CSE with AI & Machine Learning", degree: "B.Tech", durationYears: 4, feesPerYear: 295000, seats: 400, eligibility: "VITEEE rank" },
      { id: "vit-ece", collegeId: "vit-vellore", name: "Electronics and Communication", degree: "B.Tech", durationYears: 4, feesPerYear: 280000, seats: 450, eligibility: "VITEEE rank" },
      { id: "vit-mba", collegeId: "vit-vellore", name: "Master of Business Administration", degree: "MBA", durationYears: 2, feesPerYear: 350000, seats: 240, eligibility: "CAT/MAT/XAT" },
    ],
    placements: [
      { id: "vit-p2024", collegeId: "vit-vellore", year: 2024, avgPackageLPA: 9.8, medianPackageLPA: 8.5, highestPackageLPA: 102.0, placementPercentage: 88.5, topRecruiters: ["Microsoft", "Motorq", "Amazon", "TCS Digital", "Deloitte", "Wipro Turbo"] },
      { id: "vit-p2023", collegeId: "vit-vellore", year: 2023, avgPackageLPA: 9.2, medianPackageLPA: 8.0, highestPackageLPA: 75.0, placementPercentage: 90.2, topRecruiters: ["AppDynamics", "Qualcomm", "Cognizant", "Infosys"] },
    ],
    reviews: [
  ...
  // 9. IIIT Hyderabad
  {
    ...
    courses: [
      { id: "iiith-cse", collegeId: "iiit-hyderabad", name: "Computer Science and Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 400000, seats: 150, eligibility: "JEE Main top percentiles / UGEE" },
      { id: "iiith-ece", collegeId: "iiit-hyderabad", name: "Electronics and Communication Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 400000, seats: 90, eligibility: "JEE Main / UGEE" },
      { id: "iiith-dual", collegeId: "iiit-hyderabad", name: "Dual Degree B.Tech + MS by Research in CSE", degree: "Dual Degree", durationYears: 5, feesPerYear: 400000, seats: 60, eligibility: "UGEE Exam" },
    ],
    placements: [
      { id: "iiith-p2024", collegeId: "iiit-hyderabad", year: 2024, avgPackageLPA: 30.2, medianPackageLPA: 26.0, highestPackageLPA: 120.0, placementPercentage: 97.5, topRecruiters: ["Google", "Meta", "Apple", "Uber", "Tower Research", "Databricks"] },
      { id: "iiith-p2023", collegeId: "iiit-hyderabad", year: 2023, avgPackageLPA: 28.5, medianPackageLPA: 24.5, highestPackageLPA: 105.0, placementPercentage: 98.2, topRecruiters: ["Microsoft", "Rubrik", "Adobe", "Qualcomm"] },
    ],
    reviews: [
  ...
  // 10. Delhi Technological University (DTU)
  {
    ...
    courses: [
      { id: "dtu-cse", collegeId: "dtu-delhi", name: "Computer Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 219000, seats: 360, eligibility: "JEE Main (JAC Delhi Counseling)" },
      { id: "dtu-it", collegeId: "dtu-delhi", name: "Information Technology", degree: "B.Tech", durationYears: 4, feesPerYear: 219000, seats: 180, eligibility: "JEE Main (JAC Delhi)" },
      { id: "dtu-ece", collegeId: "dtu-delhi", name: "Electronics and Communication", degree: "B.Tech", durationYears: 4, feesPerYear: 219000, seats: 240, eligibility: "JEE Main (JAC Delhi)" },
      { id: "dtu-mech", collegeId: "dtu-delhi", name: "Mechanical Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 219000, seats: 300, eligibility: "JEE Main (JAC Delhi)" },
    ],
    placements: [
      { id: "dtu-p2024", collegeId: "dtu-delhi", year: 2024, avgPackageLPA: 16.4, medianPackageLPA: 14.0, highestPackageLPA: 82.0, placementPercentage: 90.0, topRecruiters: ["Google", "Amazon", "Microsoft", "Tower Research", "Texas Instruments", "Maruti Suzuki"] },
      { id: "dtu-p2023", collegeId: "dtu-delhi", year: 2023, avgPackageLPA: 15.2, medianPackageLPA: 13.0, highestPackageLPA: 64.0, placementPercentage: 92.5, topRecruiters: ["Adobe", "Goldman Sachs", "Cisco", "Deloitte"] },
    ],
    reviews: [
    ...
    cutoffs: [
      ...
      { id: "c-dtu-cse-sc", collegeId: "dtu-delhi", exam: "JEE Main", category: "SC", year: 2024, closingRank: 42000, course: "Computer Engineering" },
      { id: "c-dtu-ece-gen", collegeId: "dtu-delhi", exam: "JEE Main", category: "General", year: 2024, closingRank: 12000, course: "Electronics and Communication" },
      { id: "c-dtu-mech-gen", collegeId: "dtu-delhi", exam: "JEE Main", category: "General", year: 2024, closingRank: 26000, course: "Mechanical Engineering" },
    ],
  },
  ...
  // 11. Manipal Institute of Technology (MIT Manipal)
  {
    ...
    courses: [
      { id: "mit-cse", collegeId: "mit-manipal", name: "Computer Science and Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 435000, seats: 240, eligibility: "MET (Manipal Entrance Test)" },
      { id: "mit-cce", collegeId: "mit-manipal", name: "Computer and Communication Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 435000, seats: 180, eligibility: "MET" },
      { id: "mit-mech", collegeId: "mit-manipal", name: "Mechanical Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 380000, seats: 200, eligibility: "MET" },
    ],
    placements: [
      { id: "mit-p2024", collegeId: "mit-manipal", year: 2024, avgPackageLPA: 12.2, medianPackageLPA: 10.0, highestPackageLPA: 54.0, placementPercentage: 89.0, topRecruiters: ["Microsoft", "Amazon", "Goldman Sachs", "Cisco", "Bosch", "Accenture"] },
      { id: "mit-p2023", collegeId: "mit-manipal", year: 2023, avgPackageLPA: 11.5, medianPackageLPA: 9.2, highestPackageLPA: 44.0, placementPercentage: 91.0, topRecruiters: ["Dell", "Oracle", "SAP Labs", "Mercedes-Benz"] },
    ],
    reviews: [
  ...
  // 12. IIT Roorkee
  {
    ...
    courses: [
      { id: "iitr-cse", collegeId: "iit-roorkee", name: "Computer Science and Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 218000, seats: 110, eligibility: "JEE Advanced" },
      { id: "iitr-ee", collegeId: "iit-roorkee", name: "Electrical Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 218000, seats: 120, eligibility: "JEE Advanced" },
      { id: "iitr-civil", collegeId: "iit-roorkee", name: "Civil Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 218000, seats: 150, eligibility: "JEE Advanced" },
      { id: "iitr-mba", collegeId: "iit-roorkee", name: "MBA (DoMS)", degree: "MBA", durationYears: 2, feesPerYear: 420000, seats: 95, eligibility: "CAT 95+ percentile" },
    ],
    placements: [
      { id: "iitr-p2024", collegeId: "iit-roorkee", year: 2024, avgPackageLPA: 20.8, medianPackageLPA: 17.5, highestPackageLPA: 130.0, placementPercentage: 92.0, topRecruiters: ["Microsoft", "Google", "Databricks", "Goldman Sachs", "Qualcomm", "Schlumberger"] },
      { id: "iitr-p2023", collegeId: "iit-roorkee", year: 2023, avgPackageLPA: 19.5, medianPackageLPA: 16.5, highestPackageLPA: 106.0, placementPercentage: 94.0, topRecruiters: ["Oracle", "Uber", "Texas Instruments", "ITC"] },
    ],
    reviews: [
  ...
  // 13. IIT Kharagpur
  {
    ...
    courses: [
      { id: "iitkgp-cse", collegeId: "iit-kharagpur", name: "Computer Science and Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 216000, seats: 130, eligibility: "JEE Advanced" },
      { id: "iitkgp-ece", collegeId: "iit-kharagpur", name: "Electronics & Electrical Communication", degree: "B.Tech", durationYears: 4, feesPerYear: 216000, seats: 120, eligibility: "JEE Advanced" },
      { id: "iitkgp-mech", collegeId: "iit-kharagpur", name: "Mechanical Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 216000, seats: 160, eligibility: "JEE Advanced" },
      { id: "iitkgp-law", collegeId: "iit-kharagpur", name: "LL.B in Intellectual Property Law", degree: "LL.B", durationYears: 3, feesPerYear: 180000, seats: 50, eligibility: "Graduate degree in science/tech" },
    ],
    placements: [
      { id: "iitkgp-p2024", collegeId: "iit-kharagpur", year: 2024, avgPackageLPA: 21.5, medianPackageLPA: 17.8, highestPackageLPA: 145.0, placementPercentage: 91.5, topRecruiters: ["Google", "Microsoft", "Apple", "Jane Street", "Goldman Sachs", "Texas Instruments"] },
      { id: "iitkgp-p2023", collegeId: "iit-kharagpur", year: 2023, avgPackageLPA: 20.1, medianPackageLPA: 16.8, highestPackageLPA: 120.0, placementPercentage: 93.8, topRecruiters: ["Amazon", "Uber", "Qualcomm", "McKinsey"] },
    ],
    reviews: [
  ...
  // 14. NIT Surathkal (Karnataka)
  {
    ...
    courses: [
      { id: "nitk-cse", collegeId: "nitk-surathkal", name: "Computer Science and Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 160000, seats: 120, eligibility: "JEE Main (JoSAA counseling)" },
      { id: "nitk-it", collegeId: "nitk-surathkal", name: "Information Technology", degree: "B.Tech", durationYears: 4, feesPerYear: 160000, seats: 110, eligibility: "JEE Main" },
      { id: "nitk-ece", collegeId: "nitk-surathkal", name: "Electronics & Communication", degree: "B.Tech", durationYears: 4, feesPerYear: 160000, seats: 120, eligibility: "JEE Main" },
    ],
    placements: [
      { id: "nitk-p2024", collegeId: "nitk-surathkal", year: 2024, avgPackageLPA: 16.2, medianPackageLPA: 13.5, highestPackageLPA: 54.0, placementPercentage: 92.0, topRecruiters: ["Microsoft", "Google", "Amazon", "DE Shaw", "Oracle", "Texas Instruments"] },
      { id: "nitk-p2023", collegeId: "nitk-surathkal", year: 2023, avgPackageLPA: 15.1, medianPackageLPA: 12.8, highestPackageLPA: 49.0, placementPercentage: 94.2, topRecruiters: ["Qualcomm", "Cisco", "Goldman Sachs", "Morgan Stanley"] },
    ],
    reviews: [
  ...
  // 15. College of Engineering, Pune (COEP)
  {
    ...
    courses: [
      { id: "coep-cse", collegeId: "coep-pune", name: "Computer Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 95000, seats: 120, eligibility: "MHT CET / JEE Main" },
      { id: "coep-entc", collegeId: "coep-pune", name: "Electronics & Telecommunication", degree: "B.Tech", durationYears: 4, feesPerYear: 95000, seats: 120, eligibility: "MHT CET / JEE Main" },
      { id: "coep-mech", collegeId: "coep-pune", name: "Mechanical Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 95000, seats: 150, eligibility: "MHT CET / JEE Main" },
    ],
    placements: [
      { id: "coep-p2024", collegeId: "coep-pune", year: 2024, avgPackageLPA: 12.8, medianPackageLPA: 10.5, highestPackageLPA: 45.0, placementPercentage: 88.0, topRecruiters: ["Mastercard", "Credit Suisse", "Microsoft", "Tata Motors", "Bajaj Auto", "Mercedes-Benz"] },
      { id: "coep-p2023", collegeId: "coep-pune", year: 2023, avgPackageLPA: 11.9, medianPackageLPA: 9.8, highestPackageLPA: 40.0, placementPercentage: 90.5, topRecruiters: ["Barclays", "Goldman Sachs", "Siemens", "TCS"] },
    ],
    reviews: [
  ...
  // 16. SRM Institute of Science and Technology (SRM Chennai)
  {
    college: {
      ...
      city: "Chennai",
      state: "Tamil Nadu",
      location: { lat: 12.8230, lng: 80.0454 },
      type: "Deemed",
      established: 1985,
      feesPerYear: 320000,
      rating: 4.5,
    ...
    courses: [
      { id: "srm-cse", collegeId: "srm-chennai", name: "Computer Science and Engineering", degree: "B.Tech", durationYears: 4, feesPerYear: 320000, seats: 1200, eligibility: "SRMJEEE exam rank" },
      { id: "srm-ai", collegeId: "srm-chennai", name: "CSE with Artificial Intelligence", degree: "B.Tech", durationYears: 4, feesPerYear: 320000, seats: 600, eligibility: "SRMJEEE" },
      { id: "srm-mba", collegeId: "srm-chennai", name: "Master of Business Administration", degree: "MBA", durationYears: 2, feesPerYear: 400000, seats: 300, eligibility: "CAT/MAT/TANCET" },
    ],
    placements: [
      { id: "srm-p2024", collegeId: "srm-chennai", year: 2024, avgPackageLPA: 9.2, medianPackageLPA: 7.8, highestPackageLPA: 65.0, placementPercentage: 86.0, topRecruiters: ["Amazon", "PayPal", "Barclays", "TCS Ninja & Digital", "Cognizant", "Wipro"] },
      { id: "srm-p2023", collegeId: "srm-chennai", year: 2023, avgPackageLPA: 8.6, medianPackageLPA: 7.2, highestPackageLPA: 57.0, placementPercentage: 88.5, topRecruiters: ["Adobe", "Microsoft", "Capgemini", "Infosys"] },
    ],
    reviews: [
  ...
  // 17. National Law School of India University (NLSIU Bangalore)
  {
    ...
    courses: [
      { id: "nls-ballb", collegeId: "nlsiu-bangalore", name: "B.A. LL.B. (Hons)", degree: "B.A. LL.B.", durationYears: 5, feesPerYear: 375000, seats: 240, eligibility: "CLAT Top Ranks" },
      { id: "nls-llm", collegeId: "nlsiu-bangalore", name: "Master of Laws (LL.M.)", degree: "LL.M.", durationYears: 1, feesPerYear: 280000, seats: 100, eligibility: "CLAT PG" },
    ],
    placements: [
      { id: "nls-p2024", collegeId: "nlsiu-bangalore", year: 2024, avgPackageLPA: 18.5, medianPackageLPA: 16.0, highestPackageLPA: 38.0, placementPercentage: 98.0, topRecruiters: ["Cyril Amarchand Mangaldas", "Shardul Amarchand Mangaldas", "AZB & Partners", "Trilegal", "Khaitan & Co", "Linklaters UK"] },
      { id: "nls-p2023", collegeId: "nlsiu-bangalore", year: 2023, avgPackageLPA: 17.2, medianPackageLPA: 15.0, highestPackageLPA: 34.0, placementPercentage: 99.0, topRecruiters: ["Luthra and Luthra", "Clifford Chance", "JSA"] },
    ],
    reviews: [
  ...
  // 18. National Institute of Design (NID Ahmedabad)
  {
    ...
    courses: [
      { id: "nid-bdes", collegeId: "nid-ahmedabad", name: "Bachelor of Design (B.Des)", degree: "B.Des", durationYears: 4, feesPerYear: 395000, seats: 125, eligibility: "NID DAT (Design Aptitude Test)" },
      { id: "nid-mdes", collegeId: "nid-ahmedabad", name: "Master of Design (M.Des)", degree: "M.Des", durationYears: 2.5, feesPerYear: 440000, seats: 100, eligibility: "NID DAT Prelims & Mains" },
    ],
    placements: [
      { id: "nid-p2024", collegeId: "nid-ahmedabad", year: 2024, avgPackageLPA: 16.0, medianPackageLPA: 14.2, highestPackageLPA: 42.0, placementPercentage: 93.0, topRecruiters: ["Google UX", "Microsoft Design", "Samsung Design Delhi", "Adobe", "Tata Motors Design Studio", "IKEA"] },
      { id: "nid-p2023", collegeId: "nid-ahmedabad", year: 2023, avgPackageLPA: 14.8, medianPackageLPA: 13.0, highestPackageLPA: 36.0, placementPercentage: 95.0, topRecruiters: ["Frog Design", "Wipro Digital", "Infosys Experience Design", "Maruti Design"] },
    ],
    reviews: [
  ...
  // 19. Christian Medical College (CMC Vellore)
  {
    ...
    courses: [
      { id: "cmc-mbbs", collegeId: "cmc-vellore", name: "MBBS", degree: "MBBS", durationYears: 5.5, feesPerYear: 53000, seats: 100, eligibility: "NEET Rank + CMC Aptitude Assessment" },
      { id: "cmc-nursing", collegeId: "cmc-vellore", name: "B.Sc Nursing", degree: "B.Sc", durationYears: 4, feesPerYear: 38000, seats: 100, eligibility: "NEET / CMC entrance" },
    ],
    placements: [
      { id: "cmc-p2024", collegeId: "cmc-vellore", year: 2024, avgPackageLPA: 14.5, medianPackageLPA: 13.0, highestPackageLPA: 35.0, placementPercentage: 99.0, topRecruiters: ["CMC Hospital System", "Apollo Hospitals", "Fortis", "NHS UK", "WHO Fellowships"] },
      { id: "cmc-p2023", collegeId: "cmc-vellore", year: 2023, avgPackageLPA: 13.8, medianPackageLPA: 12.2, highestPackageLPA: 30.0, placementPercentage: 99.0, topRecruiters: ["Manipal Hospitals", "Max Healthcare"] },
    ],
    reviews: [
  ...
  // 20. St. Stephen's College (University of Delhi)
  {
    ...
    courses: [
      { id: "stephens-eco", collegeId: "st-stephens-delhi", name: "B.A. (Hons) Economics", degree: "B.A.", durationYears: 3, feesPerYear: 42000, seats: 60, eligibility: "CUET UG top percentiles" },
      { id: "stephens-phy", collegeId: "st-stephens-delhi", name: "B.Sc (Hons) Physics", degree: "B.Sc", durationYears: 3, feesPerYear: 46000, seats: 60, eligibility: "CUET UG" },
      { id: "stephens-eng", collegeId: "st-stephens-delhi", name: "B.A. (Hons) English", degree: "B.A.", durationYears: 3, feesPerYear: 42000, seats: 45, eligibility: "CUET UG" },
    ],
    placements: [
      { id: "stephens-p2024", collegeId: "st-stephens-delhi", year: 2024, avgPackageLPA: 11.2, medianPackageLPA: 9.5, highestPackageLPA: 30.0, placementPercentage: 88.0, topRecruiters: ["Bain Capability Network", "McKinsey", "DE Shaw", "LEK Consulting", "EY Parthenon", "Teach for India"] },
      { id: "stephens-p2023", collegeId: "st-stephens-delhi", year: 2023, avgPackageLPA: 10.4, medianPackageLPA: 8.8, highestPackageLPA: 26.0, placementPercentage: 89.5, topRecruiters: ["Dalberg", "BCG", "KPMG", "Nomura"] },
    ],
    reviews: [
...
// Helper to generate remaining 22+ colleges programmatically so we guarantee ≥42 realistic, authentic institutions across diverse states!
const ADDITIONAL_COLLEGES_META: {
  id: string;
  name: string;
  city: string;
  state: string;
  ...
  maxLPA: number;
  overview: string;
  exam: "JEE Main" | "JEE Advanced" | "NEET" | "CAT";
  cutoffRank: number;
}[] = [
  { id: "iit-guwahati", name: "IIT Guwahati (IITG)", city: "Guwahati", state: "Assam", lat: 26.1878, lng: 91.6916, type: "Government", established: 1994, fees: 215000, rating: 4.8, reviews: 26, streams: ["Engineering", "Design", "Arts & Sciences"], nirf: 7, degrees: ["B.Tech CSE", "B.Des", "B.Tech ECE"], avgLPA: 20.5, maxLPA: 120.0, overview: "Set on the majestic northern banks of the Brahmaputra River, IIT Guwahati is celebrated for picturesque hills, world-renowned Department of Design, and high-performance computing centers.", exam: "JEE Advanced", cutoffRank: 650 },
  { id: "iit-hyderabad-inst", name: "IIT Hyderabad (IITH)", city: "Sangareddy", state: "Telangana", lat: 17.5947, lng: 78.1230, type: "Government", established: 2008, fees: 220000, rating: 4.8, reviews: 22, streams: ["Engineering", "Design"], nirf: 8, degrees: ["B.Tech AI", "B.Tech CSE", "B.Tech Electrical"], avgLPA: 21.0, maxLPA: 110.0, overview: "Known for pioneering the Fractal Academic System and India's first B.Tech in Artificial Intelligence, IIT Hyderabad is one of the fastest rising elite institutes in the nation.", exam: "JEE Advanced", cutoffRank: 620 },
  { id: "iit-varanasi-bhu", name: "IIT (BHU) Varanasi", city: "Varanasi", state: "Uttar Pradesh", lat: 25.2677, lng: 82.9913, type: "Government", established: 1919, fees: 210000, rating: 4.7, reviews: 31, streams: ["Engineering", "Arts & Sciences"], nirf: 15, degrees: ["B.Tech CSE", "B.Tech Electronics", "B.Tech Metallurgy"], avgLPA: 19.8, maxLPA: 115.0, overview: "Carrying a centenary legacy inside the Banaras Hindu University campus, IIT BHU combines spiritual heritage with powerhouse engineering and mineral technology research.", exam: "JEE Advanced", cutoffRank: 1050 },
  { id: "iit-indore", name: "IIT Indore (IITI)", city: "Indore", state: "Madhya Pradesh", lat: 22.5204, lng: 75.9207, type: "Government", established: 2009, fees: 218000, rating: 4.7, reviews: 19, streams: ["Engineering", "Arts & Sciences"], nirf: 14, degrees: ["B.Tech CSE", "B.Tech EEE", "B.Tech Mech"], avgLPA: 18.5, maxLPA: 68.0, overview: "Known for the highest research citations per faculty in India and modern green campus architecture in Simrol, Indore.", exam: "JEE Advanced", cutoffRank: 1350 },
  { id: "iim-bangalore", name: "IIM Bangalore (IIMB)", city: "Bangalore", state: "Karnataka", lat: 12.8953, lng: 77.6008, type: "Government", established: 1973, fees: 1350000, rating: 4.9, reviews: 25, streams: ["Management"], nirf: 2, degrees: ["PGP (MBA)", "PGP-Enterprise"], avgLPA: 35.4, maxLPA: 112.0, overview: "Surrounded by tech headquarters in Bannerghatta, IIMB is a global hub for software product management, private equity, and management research.", exam: "CAT", cutoffRank: 210 },
  { id: "iim-calcutta", name: "IIM Calcutta (IIMC)", city: "Kolkata", state: "West Bengal", lat: 22.4389, lng: 88.3075, type: "Government", established: 1961, fees: 1380000, rating: 4.9, reviews: 24, streams: ["Management"], nirf: 4, degrees: ["MBA", "PGPEX-VLM"], avgLPA: 34.8, maxLPA: 115.0, overview: "Known as the finance capital of Indian B-schools with its scenic 7-lakes Joka campus and peerless quantitative finance curriculum.", exam: "CAT", cutoffRank: 240 },
  { id: "iim-lucknow", name: "IIM Lucknow (IIML)", city: "Lucknow", state: "Uttar Pradesh", lat: 26.9200, lng: 80.9388, type: "Government", established: 1984, fees: 1100000, rating: 4.8, reviews: 20, streams: ["Management"], nirf: 6, degrees: ["PGP (MBA)", "PGP-Agribusiness"], avgLPA: 30.0, maxLPA: 95.0, overview: "One of the original IIM powerhouses, renowned for rigorous academic discipline, marketing, and general management placements.", exam: "CAT", cutoffRank: 420 },
  { id: "nit-warangal", name: "NIT Warangal (NITW)", city: "Warangal", state: "Telangana", lat: 17.9839, lng: 79.5308, type: "Government", established: 1959, fees: 158000, rating: 4.7, reviews: 28, streams: ["Engineering", "Management"], nirf: 21, degrees: ["B.Tech CSE", "B.Tech ECE", "B.Tech Mech"], avgLPA: 15.6, maxLPA: 88.0, overview: "The very first Regional Engineering College founded by Jawaharlal Nehru, NIT Warangal features high-energy coding culture and strong core engineering labs.", exam: "JEE Main", cutoffRank: 2250 },
  { id: "nit-rourkela", name: "NIT Rourkela", city: "Rourkela", state: "Odisha", lat: 22.2531, lng: 84.9010, type: "Government", established: 1961, fees: 152000, rating: 4.7, reviews: 25, streams: ["Engineering", "Arts & Sciences"], nirf: 16, degrees: ["B.Tech CSE", "B.Tech Mining", "B.Tech Metallurgy"], avgLPA: 14.8, maxLPA: 52.0, overview: "Spanning 647 lush acres with specialized industrial metallurgical, mining, and software engineering centers.", exam: "JEE Main", cutoffRank: 3100 },
  { id: "nit-calicut", name: "NIT Calicut (NITC)", city: "Kozhikode", state: "Kerala", lat: 11.3216, lng: 75.9336, type: "Government", established: 1961, fees: 155000, rating: 4.6, reviews: 24, streams: ["Engineering", "Management"], nirf: 23, degrees: ["B.Tech CSE", "B.Tech EEE", "B.Arch"], avgLPA: 14.2, maxLPA: 50.0, overview: "Located in Chathamangalam amidst Kerala's scenic greenery, known for its strong technical fests (Tathva & Ragam) and architecture department.", exam: "JEE Main", cutoffRank: 4200 },
  { id: "nsut-delhi", name: "Netaji Subhas University of Technology (NSUT)", city: "New Delhi", state: "Delhi", lat: 28.6083, lng: 77.0367, type: "Government", established: 1983, fees: 219000, rating: 4.7, reviews: 29, streams: ["Engineering", "Management"], nirf: 60, degrees: ["B.Tech CSE", "B.Tech IT", "B.Tech ECE"], avgLPA: 16.0, maxLPA: 78.0, overview: "Spread over 145 acres in Dwarka, NSUT boasts massive tech placements on par with top IITs and an active competitive coding community.", exam: "JEE Main", cutoffRank: 3800 },
  { id: "iiit-delhi", name: "Indraprastha Institute of Information Technology Delhi (IIIT-D)", city: "New Delhi", state: "Delhi", lat: 28.5459, lng: 77.2732, type: "Government", established: 2008, fees: 425000, rating: 4.8, reviews: 22, streams: ["Engineering", "Design"], nirf: 75, degrees: ["B.Tech CSE", "B.Tech CSAM", "B.Tech CSD"], avgLPA: 20.2, maxLPA: 85.0, overview: "A research-focused autonomous state university in Okhla with world-class faculty in Cybersecurity, Human-Centered Design, and AI.", exam: "JEE Main", cutoffRank: 2900 },
  { id: "iiit-bangalore", name: "IIIT Bangalore (IIIT-B)", city: "Bangalore", state: "Karnataka", lat: 12.8440, lng: 77.6633, type: "Deemed", established: 1999, fees: 440000, rating: 4.8, reviews: 21, streams: ["Engineering"], nirf: 74, degrees: ["Integrated M.Tech CSE", "Integrated M.Tech ECE"], avgLPA: 24.5, maxLPA: 92.0, overview: "Located in Electronic City Bangalore right alongside Infosys, Wipro, and Siemens, offering high-impact research and high placement packages.", exam: "JEE Main", cutoffRank: 4800 },
  { id: "thapar-patiala", name: "Thapar Institute of Engineering and Technology", city: "Patiala", state: "Punjab", lat: 30.3564, lng: 76.3647, type: "Deemed", established: 1956, fees: 410000, rating: 4.6, reviews: 33, streams: ["Engineering", "Management"], nirf: 22, degrees: ["B.E. Computer Engg", "B.E. Electronics", "B.E. Mechanical"], avgLPA: 11.5, maxLPA: 55.0, overview: "A historic 250-acre private campus with an academic collaboration with Trinity College Dublin and modern learning laboratories.", exam: "JEE Main", cutoffRank: 12500 },
  { id: "psg-tech-coimbatore", name: "PSG College of Technology", city: "Coimbatore", state: "Tamil Nadu", lat: 11.0247, lng: 77.0028, type: "Private", established: 1951, fees: 88000, rating: 4.6, reviews: 27, streams: ["Engineering", "Management"], nirf: 63, degrees: ["B.E. CSE", "B.E. Robotics", "B.Tech Textile"], avgLPA: 9.8, maxLPA: 38.0, overview: "Renowned for deep industry-academia linkages in South India, in-house industrial workshops, and high core engineering hiring.", exam: "JEE Main", cutoffRank: 8400 },
  { id: "rvce-bangalore", name: "R.V. College of Engineering (RVCE)", city: "Bangalore", state: "Karnataka", lat: 12.9237, lng: 77.4987, type: "Private", established: 1963, fees: 280000, rating: 4.6, reviews: 31, streams: ["Engineering"], nirf: 89, degrees: ["B.E. Computer Science", "B.E. Information Science", "B.E. ECE"], avgLPA: 12.4, maxLPA: 62.0, overview: "Bangalore's topmost private engineering college on Mysore Road with unparalleled Silicon Valley of India recruitment.", exam: "JEE Main", cutoffRank: 1600 },
  { id: "bmsce-bangalore", name: "BMS College of Engineering (BMSCE)", city: "Bangalore", state: "Karnataka", lat: 12.9416, lng: 77.5658, type: "Private", established: 1946, fees: 260000, rating: 4.5, reviews: 28, streams: ["Engineering", "Management"], nirf: 83, degrees: ["B.E. Computer Science", "B.E. Electronics", "B.E. Civil"], avgLPA: 10.8, maxLPA: 50.0, overview: "The first private engineering college in India, located in Basavanagudi, Bangalore with vibrant cultural fest Utsav.", exam: "JEE Main", cutoffRank: 3200 },
  { id: "vjti-mumbai", name: "Veermata Jijabai Technological Institute (VJTI Mumbai)", city: "Mumbai", state: "Maharashtra", lat: 19.0222, lng: 72.8561, type: "Government", established: 1887, fees: 85000, rating: 4.7, reviews: 27, streams: ["Engineering"], nirf: 82, degrees: ["B.Tech Computer Engg", "B.Tech IT", "B.Tech Mechanical"], avgLPA: 13.5, maxLPA: 60.0, overview: "Situated in Matunga, Mumbai, VJTI is a premier government institute known for rich alumni heritage and top tier tech recruiting.", exam: "JEE Main", cutoffRank: 3100 },
  { id: "jadavpur-university", name: "Jadavpur University (Faculty of Engineering)", city: "Kolkata", state: "West Bengal", lat: 22.4989, lng: 88.3718, type: "Government", established: 1955, fees: 10000, rating: 4.8, reviews: 35, streams: ["Engineering", "Arts & Sciences"], nirf: 10, degrees: ["B.E. Computer Science", "B.E. Electronics", "B.E. Power Engg"], avgLPA: 16.5, maxLPA: 85.0, overview: "Legendary for its world-class research output and nominal fees (under ₹10k for 4 years), producing stellar researchers and engineers.", exam: "JEE Main", cutoffRank: 1400 },
  { id: "king-george-medical", name: "King George's Medical University (KGMU)", city: "Lucknow", state: "Uttar Pradesh", lat: 26.8687, lng: 80.9133, type: "Government", established: 1911, fees: 54000, rating: 4.8, reviews: 24, streams: ["Medical"], nirf: 12, degrees: ["MBBS", "BDS"], avgLPA: 15.0, maxLPA: 38.0, overview: "A historic medical university in Lucknow with one of India's largest bed capacities and trauma centers.", exam: "NEET", cutoffRank: 850 },
  { id: "madras-medical-college", name: "Madras Medical College (MMC Chennai)", city: "Chennai", state: "Tamil Nadu", lat: 13.0805, lng: 80.2774, type: "Government", established: 1835, fees: 18000, rating: 4.9, reviews: 26, streams: ["Medical"], nirf: 11, degrees: ["MBBS", "B.Pharm"], avgLPA: 14.0, maxLPA: 32.0, overview: "The third oldest medical college in India and one of the most respected teaching hospitals in South India.", exam: "NEET", cutoffRank: 650 },
  { id: "grant-medical-college", name: "Grant Medical College & Sir JJ Group of Hospitals", city: "Mumbai", state: "Maharashtra", lat: 18.9633, lng: 72.8336, type: "Government", established: 1845, fees: 115000, rating: 4.8, reviews: 25, streams: ["Medical"], nirf: 19, degrees: ["MBBS", "B.Sc Nursing"], avgLPA: 14.5, maxLPA: 35.0, overview: "One of South Asia's foremost historic medical institutions, situated in Byculla, Mumbai with massive clinical bed volume.", exam: "NEET", cutoffRank: 780 },
];
